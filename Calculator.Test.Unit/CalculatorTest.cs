...
namespace Calculator.Test.Unit
{
    ...
    class CalculatorTest
    {
        ...
        [TestCase(0, 0)]
        [TestCase(20, 20)]
        public void Add_AddaToEmptyAccumulator_Expectb(double a, double b)
        {
            Assert.That(uut.Add(a), Is.EqualTo(b));
        }
        ...
        [TestCase(3, 0)]
        [TestCase(-3, 0)]
        public void Divide_DivideaWith0_ThrowsDivideByZeroException(double a, double b)
        {
        ...
        [TestCase(0)]
        public void Divide_DivideaAccumulatorWith0_ThrowsDivideByZeroException(double a)
        {
        ...
        [TestCase(2.3)]
        [TestCase(-0.3)]
        public void Power_NegativeAccumulatorNonIntegerexp_ThrowsNegativeBaseNumberFloatingExponentException(double exp)
        {
            uut.Add(-2);

            Assert.That(() => uut.Power(exp), Throws.TypeOf<LabCalculator.NegativeBaseNumberFloatingExponentException>());
        }
